...
function fileList(table) {
	...
	var header = '<tr class="head"><th class="col1">&nbsp;</th>' +
		'<th class="col2" str="filename" localization>' + strings['filename'] + '</th><th class="col3" str="state" localization>' + strings['state'] + '</th>' +
	...
	r = {
		...
		clear: function() {
			obj.html(header + '<tr class="no-file"><td></td><td str="nofile" localization>' + strings['nofile'] + '</td><td></td><td></td><td></td></tr>');
			elements = [];
		...
		'<th class="col4" str="timestamp" localization>' + strings['timestamp'] + '</th><th class="col5">&nbsp;</th></tr>';
				...
				header = '<tr class="head"><th class="col1">&nbsp;</th>' +
		'<th class="col2" str="filename" localization>' + strings['filename'] + '</th><th class="col3 owner" str="owner" localization>' + strings['owner'] + '</th>' +
		'<th class="col4" str="timestamp" localization>' + strings['timestamp'] + '</th><th class="col5">&nbsp;</th></tr>';
		},
